...
if (!function_exists('b4st_enqueues')) {
	function b4st_enqueues()
	{
		...
		wp_register_style('fontawesome7', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/7.0.1/css/all.min.css', false, '7.0.1', null);
		wp_enqueue_style('fontawesome7');

		wp_enqueue_style('gutenberg-blocks', get_template_directory_uri() . '/theme/css/blocks.css');

		wp_register_style('slick',  '//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css', false, null);
		...
		wp_register_script('bootstrap5', 'https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.min.js', false, '5.2.3', true);
		wp_enqueue_script('bootstrap5');

		wp_register_script('slick', '//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js', false, null, true);
